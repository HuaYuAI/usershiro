...
<table class="easyui-datagrid" id="itemList" title="全部用户"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'${pageContext.request.contextPath}/userList',method:'get',pageSize:30,toolbar:toolbar">
    <thead>
        <tr>
            ...
            <th data-options="field:'registertime',width:230,align:'center',formatter:E3.formatDateTime">注册日期</th>
            <th data-options="field:'connecttime',width:230,align:'center',formatter:E3.formatDateTime">登陆日期</th>
            <th data-options="field:'logouttime',width:230,align:'center',formatter:E3.formatDateTime">注销日期</th>
        </tr>
    </thead>
</table>
